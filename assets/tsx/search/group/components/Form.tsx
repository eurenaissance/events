        ...
        return (
            <div className="search__form">
                <div className="search__form__label">
                    {translations['group_search.find']}
                </div>
                <div className="search__form__term">
                    <input type="text" className="form-control" placeholder={translations['group_search.all_groups']}
                           onInput={(e) => this.onTermChange(e)} />
                </div>
                <div className="search__form__label">
                    {translations['group_search.around']}
                </div>
                    ...
                    <div className="autocomplete">
                        <Autosuggest
                            ...
                            inputProps={{
                                ...
                                placeholder: translations['group_search.any_city']
                            }} />
                    </div>
                </div>
            </div>
