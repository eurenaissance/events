 ...
 */
final class Version20190201195935 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE groups (id BIGINT NOT NULL, animator_id BIGINT NOT NULL, city_id BIGINT NOT NULL, name VARCHAR(50) NOT NULL, description TEXT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, uuid UUID NOT NULL, address VARCHAR(150) DEFAULT NULL, slug VARCHAR(255) NOT NULL, approved_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, refused_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE events (id BIGINT NOT NULL, creator_id BIGINT NOT NULL, group_id BIGINT NOT NULL, city_id BIGINT NOT NULL, name VARCHAR(50) NOT NULL, description TEXT NOT NULL, begin_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, finish_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, uuid UUID NOT NULL, address VARCHAR(150) DEFAULT NULL, slug VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
