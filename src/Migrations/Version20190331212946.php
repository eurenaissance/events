...
final class Version20190331212946 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE actors (id BIGINT NOT NULL, city_id BIGINT NOT NULL, email_address VARCHAR(255) NOT NULL, first_name VARCHAR(50) NOT NULL, last_name VARCHAR(50) NOT NULL, birthday DATE NOT NULL, gender VARCHAR(6) DEFAULT NULL, password VARCHAR(255) NOT NULL, registered_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, confirmed_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, notification_enabled BOOLEAN NOT NULL, uuid UUID NOT NULL, address VARCHAR(150) DEFAULT NULL, coordinates Geometry(Point) DEFAULT NULL, coordinates_accuracy VARCHAR(10) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE contents (id BIGINT NOT NULL, title VARCHAR(255) NOT NULL, content TEXT NOT NULL, url VARCHAR(255) NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE configuration (id BIGINT NOT NULL, party_name VARCHAR(50) NOT NULL, party_logo VARCHAR(200) NOT NULL, party_website VARCHAR(200) NOT NULL, color_primary VARCHAR(8) NOT NULL, font_primary VARCHAR(50) NOT NULL, font_mono VARCHAR(50) NOT NULL, favicon VARCHAR(200) NOT NULL, meta_description VARCHAR(200) NOT NULL, meta_image VARCHAR(200) NOT NULL, meta_google_analytics_id VARCHAR(30) DEFAULT NULL, home_image VARCHAR(200) NOT NULL, home_intro_subtitle VARCHAR(50) NOT NULL, home_intro_title VARCHAR(30) NOT NULL, home_intro_button VARCHAR(50) NOT NULL, home_display_map BOOLEAN NOT NULL, email_sender VARCHAR(200) NOT NULL, email_sender_name VARCHAR(50) DEFAULT NULL, email_contact VARCHAR(200) DEFAULT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE contact_messages (id BIGINT NOT NULL, sender VARCHAR(100) NOT NULL, recipient VARCHAR(100) NOT NULL, subject VARCHAR(100) NOT NULL, message TEXT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE api_tokens (id INT NOT NULL, description VARCHAR(255) NOT NULL, token VARCHAR(50) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
